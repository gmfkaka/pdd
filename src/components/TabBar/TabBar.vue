<template>
 <div class="bottom-tab">
     ...
     <span class="tab-item" @click="switchTo('/shop')">
         <img :src="$route.path.includes('/shop') ? tabBarImgArr[3].selected :tabBarImgArr[3].normal" alt="">
         <span :class="{on:$route.path.includes('/shop')}">购物车</span>
     </span>
